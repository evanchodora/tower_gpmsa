...
% Set up prediction grid
 ...
 if doPlot(1)
   ...
   figure(1); print -dpng scRhoBox; close;
 ...
 if doPlot(2)
   ...
   figure(2); print -dpng scPost; close;
 end    
 ...
 % plot
   ...
   figure(3); print -dpng scPreds; close;
 end
 ...
 if doPlot(4)
   ...
   axisNorm(h,'ymax');
   figure(4); print -dpng scNomSens; close;
 end
 ...
 if doPlot(5)
   ...
   axisNorm(h,'ymax');
   figure(5); print -dpng scMeSens; close;
 end
